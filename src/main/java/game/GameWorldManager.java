...
public final class GameWorldManager extends GameEngineBase {
   ...
   private static String[] C25_f331 = new String[] { "PK6_RMS_ACTOR", "PK6_RMS_WORLD", "PK6_RMS_EVENT", "PK6_RMS_RMS",
   ...
   public GameWorldManager() {
      ...
      this.C25_f329 = new int[] { 9, 0, 20, 3, 9, 1, 17, 1, 9, 2, 9, 4, 9, 6, 86, 5, 9, 6, 58, 6, 9, 5, 21, 2, 9, 4, 3,
            0 };
      ...
      this.C25_f362 = null;
      this.C25_f363 = 8;
      this.C25_f364 = new int[] { 2, 1, 73, 158, 3, 3, 216, 165, 4, 5, 161, 338, 5, 3, 111, 385, 5, 5, 112, 124, 6, 1,
            140, 100, 7, 2, 48, 58 };
      this.C25_f365 = new int[] { 1, 5, 265, 113, 3, 6, 281, 192, 4, 0, 24, 144, 5, 2, 88, 175, 6, 0, 55, 190 };
      this.C25_f366 = new int[] { 16735795, 5708544, 5693667, 28273, 7796622, 1924393, 16774529, 7760896, 3291479,
            10268671, 2038828, 13341951, 4443391, 16777215, 1862959, 13886935 };
      this.C25_f367 = new int[][] {
   ...
   public final boolean initializeGame() {
      try {
         ...
         this.C25_f286 = PlayerCharacter.getInstance();
         ...
         if (!this.C25_f286.isInitialized) {
            if (inputEnabled) {
               this.R();
               this.T();
            }
         ...
         this.C25_f286.vehicleUsability = GameUtils.readByteMatrix(var12)[C25_f297[this.C25_f290] + this.C25_f291];
         if (this.C25_f286.currentVehicleType >= 0 && !this.C25_f286.isVehicleUsable(this.C25_f286.currentVehicleType)) {
            this.C25_f286.resetToDefaultSprite();
         }

         this.C25_f352 = this.C25_f286.vehicleUsability[4];
         this.C25_f353 = -1;
         ...
         if (this.C25_f286.effectDuration > 0) {
            this.e(true);
         }
         ...
         if (C25_f321) {
            ...
            if (!this.C25_f286.isInitialized) {
               ...
               this.C25_f286.initializeFromData(var8);
               this.C25_f286.addStarterPokemon();
            }
         ...
         if (this.C25_f290 == 3 && this.C25_f291 == 7) {
            if (this.C25_f286.brightnessEffectDuration > 0) {
               this.C25_f286.brightnessEffectDuration = 0;
            ...
            this.C25_f286.resetToDefaultSprite();
            this.C25_f286.activateVehicle(0);
         }

         if (this.C25_f290 == 5 && this.C25_f291 == 6
               || this.C25_f290 == 4 && (this.C25_f291 == 3 || this.C25_f291 == 4)) {
            if (this.C25_f286.badgeStates[0][0] == 2) {
               ScreenTransitionManager.a().a((byte) 0, this.C25_f284.getWorldX(),
                     this.C25_f284.getWorldY() - this.C25_f328[this.C25_f286.currentVehicleType + 1], getScreenWidth(),
      ...
      try {
         ...
         for (var4 = 0; var4 < var1.creatureIndexes.length; ++var4) {
            for (var5 = 0; var5 < var1.creatureIndexes[var4].length; ++var5) {
               var3.writeByte(this.C25_f286.creatureIndexes[var4][var5]);
            }
         }

         var3.writeByte(this.C25_f286.commonCreaturesSeen);
         var3.writeByte(this.C25_f286.rareCreaturesSeen);
         var3.writeByte(this.C25_f286.totalCreaturesSeen);
         var3.writeByte(this.C25_f286.pokedexCount);

         for (var4 = 0; var4 < this.C25_f286.pokedexEntries.length; ++var4) {
            var3.writeByte(this.C25_f286.pokedexEntries[var4]);
         }
         ...
         if (!this.H()) {
            ...
            if (!this.W()) {
               ...
               var3.write(this.C25_f286.outfitType);
               ...
               var3.writeLong(var9);
               var3.writeByte(this.C25_f286.currentVehicleType);
      ...
      try {
         ...
         for (var5 = 0; var5 < var1.creatureIndexes.length; ++var5) {
            for (var6 = 0; var6 < var1.creatureIndexes[var5].length; ++var6) {
               this.C25_f286.creatureIndexes[var5][var6] = var3.readByte();
            }
         }

         this.C25_f286.commonCreaturesSeen = var3.readByte();
         this.C25_f286.rareCreaturesSeen = var3.readByte();
         this.C25_f286.totalCreaturesSeen = var3.readByte();
         this.C25_f286.pokedexCount = var3.readByte();

         for (var5 = 0; var5 < this.C25_f286.pokedexEntries.length; ++var5) {
            this.C25_f286.pokedexEntries[var5] = (short) var3.readByte();
         }
         ...
         for (var6 = 0; var6 < var11; ++var6) {
            ...
            if (this.C25_f286.partyPokemon[var7[var6]] != null) {
               this.C25_f286.partyPokemon[var7[var6]].cacheOldStats();
               C25_f333.addElement(this.C25_f286.partyPokemon[var7[var6]]);
            }
         }
         ...
         var1.initializeFromData(new short[] { this.C25_f293, this.C25_f294, (short) var4, 4, 4, 8, 40, 100, 0 });
   ...
   private boolean W() {
      try {
         ByteArrayOutputStream var1 = new ByteArrayOutputStream();
         DataOutputStream var2;
         (var2 = new DataOutputStream(var1)).writeInt(this.C25_f286.getGold());
         var2.writeInt(this.C25_f286.getBadges());
   ...
   private boolean X() {
      try {
         ...
         DataInputStream var2 = new DataInputStream(var1);
         this.C25_f286.setGold(0);
         this.C25_f286.setBadges(0);
         this.C25_f286.addGold(var2.readInt());
         this.C25_f286.addBadges(var2.readInt());
         var1.close();
         var2.close();
         return true;
      } catch (IOException var3) {
   ...
   private boolean Y() {
      try {
         ByteArrayOutputStream var1 = new ByteArrayOutputStream();
         DataOutputStream var2;
         (var2 = new DataOutputStream(var1)).writeInt(this.C25_f286.consumableInventory.size());

         for (int var3 = 0; var3 < this.C25_f286.consumableInventory.size(); ++var3) {
            int[] var4 = (int[]) this.C25_f286.consumableInventory.elementAt(var3);
   ...
   private boolean Z() {
      try {
         ...
         this.C25_f286.consumableInventory.removeAllElements();
         ...
         for (int var4 = 0; var4 < var3; ++var4) {
            ...
            this.C25_f286.consumableInventory.addElement(var5);
         }
   ...
   private boolean aa() {
      try {
         ByteArrayOutputStream var1 = new ByteArrayOutputStream();
         DataOutputStream var2;
         (var2 = new DataOutputStream(var1)).writeInt(this.C25_f286.equipmentInventory.size());

         for (int var3 = 0; var3 < this.C25_f286.equipmentInventory.size(); ++var3) {
            int[] var4 = (int[]) this.C25_f286.equipmentInventory.elementAt(var3);
            var2.writeInt(var4.length);
   ...
   private boolean ab() {
      try {
         ...
         DataInputStream var2;
         int var3 = (var2 = new DataInputStream(var1)).readInt();
         this.C25_f286.equipmentInventory.removeAllElements();
         ...
         for (int var4 = 0; var4 < var3; ++var4) {
            ...
            this.C25_f286.equipmentInventory.addElement(var5);
         }
   ...
   public final boolean H() {
      try {
         ByteArrayOutputStream var1 = new ByteArrayOutputStream();
         DataOutputStream var2;
         (var2 = new DataOutputStream(var1)).writeByte(this.C25_f286.partySize);

         for (int var3 = 0; var3 < this.C25_f286.partySize; ++var3) {
            int[] var4 = this.C25_f286.partyPokemon[var3].toSaveData();
            var2.writeInt(var4.length);
   ...
   private boolean ac() {
      try {
         ...
         int var4;
         for (var4 = 0; var4 < this.C25_f286.partySize; ++var4) {
            this.C25_f286.partyPokemon[var4] = null;
         }

         this.C25_f286.partySize = 0;
         ...
         for (var4 = 0; var4 < var3; ++var4) {
            ...
            this.C25_f286.createPokemonFromData(var5);
         }
   ...
   private void ad() {
      ...
      if (!this.C25_f286.isInitialized) {
         if (inputEnabled) {
            ...
            this.C25_f286.initializeFromData(var1);
         }
      } else if (this.C25_f295 >= 0) {
         byte var3 = 2;
         int var4 = this.C25_f287[this.C25_f295].worldX
               - this.C25_f287[this.C25_f295].worldX % this.C25_f286.primaryStates[var3];
         var3 = 2;
         int var2 = this.C25_f287[this.C25_f295].worldY
      ...
      this.C25_f286.enableWildEncounter();
   ...
   public final void changeState(byte var1) {
      ...
      switch (var1) {
         case 0:
            ...
            this.C25_f286.setFacingState((byte) 0, this.C25_f286.currentDirection);
            break;
         case 1:
         ...
         case 2:
            ...
            } else if (C25_f318 != -1 && this.C25_f287[C25_f318] != null
         ...
         case 28:
            byte var6;
            for (var6 = 0; var6 < this.C25_f330.length / 4 && (this.C25_f330[var6 << 2] != this.C25_f290
                  || this.C25_f330[(var6 << 2) + 1] != this.C25_f291); ++var6) {
            }
   ...
   public final void update() {
      if (this.isActive) {
         ...
         label203: switch (this.currentState) {
            case 0:
               this.af();
               break;
            case 1:
               ...
               break;
            case 2:
               if ((C25_f318 == -1 || this.C25_f287[C25_f318] == null
                     || this.C25_f287[C25_f318].sprite.spriteSetId != 24) && this.C25_f348.questChangeState != 0) {
                  if (C25_f318 != -1 && this.C25_f287[C25_f318] != null
                        && this.C25_f287[C25_f318].sprite.spriteSetId == 20 || this.C25_f348.questChangeState == 1) {
            ...
            case 4:
               ...
               if (this.C25_f360) {
                  ...
                  if ((var1 = GameUtils.calculateEuclideanDistance(this.C25_f356, this.C25_f357, this.C25_f358,
                        this.C25_f359)) < this.C25_f363) {
                  ...
                  if (GameUtils.pageCount < GameUtils.b()) {
                     ...
                     label227: {
                        ...
                        if (this.previousState != 7) {
                           ...
                           if (C25_f318 != -1) {
                              B().a((byte) 13, B().C25_f287[C25_f318].worldX, B().C25_f287[C25_f318].worldY - 40,
                                    B().C25_f287[C25_f318]);
                           }
                        }
         ...
         if (this.currentState == 0 && !this.C25_f348.hasActiveEvent() && C25_f337 == 0 && C25_f336 != null
               && C25_f336.size() > 0) {
   ...
   public final void renderPauseScreen(Graphics var1) {
      ...
      if (this.currentState == 4) {
         ...
         for (var4 = 0; var4 < var11; var4 += 7) {
            ...
            var3.fillRoundRect(var2.C25_f356 + (var5[var4] << 4), var2.C25_f357 + (var5[var4 + 1] << 3),
                  var5[var4 + 5] << 4, var5[var4 + 6] << 3, 12, 12);
            var3.setColor(0);
            var3.drawRoundRect(var2.C25_f356 + (var5[var4] << 4), var2.C25_f357 + (var5[var4 + 1] << 3),
                  var5[var4 + 5] << 4, var5[var4 + 6] << 3, 12, 12);
            if (var4 == var6) {
               var2.C25_f361.setWorldPosition(var2.C25_f356 + (var5[var4] << 4) + 16 * var5[var4 + 5] / 2,
                     var2.C25_f357 + (var5[var4 + 1] << 3) + 8 * var5[var4 + 6] / 2 + 20);
            ...
            for (var9 = 0; var9 < var8; ++var9) {
               GameUtils.a(var3, var7[var9], var2.C25_f366[(var2.C25_f352 << 1) + 1],
                     var2.C25_f356 + (var5[var4] << 4) + 16 * var5[var4 + 5] / 2,
                     var2.C25_f357 + (var5[var4 + 1] << 3) + 8 * var5[var4 + 6] / 2
         ...
         for (var9 = 0; var9 < var11; ++var9) {
            NPCEntity var10;
            var4 = ((var10 = (NPCEntity) var2.C25_f288.elementAt(var9)).worldX * var5[var6 + 5] << 4)
                  / var13.mapPixelWidth + (var5[var6] << 4) + var2.C25_f356;
            var12 = (var10.worldY * var5[var6 + 6] << 3) / var13.mapPixelHeight + (var5[var6 + 1] << 3) + var2.C25_f357;
            if (var10.getFacingDirection() != 0
                  && ((NPCEntity) var2.C25_f288.elementAt(var9)).getFacingDirection() != 1) {
         ...
         if (var2.C25_f353 != -1) {
            var4 = (var2.C25_f364[(var2.C25_f353 << 2) + 2] * var5[var6 + 5] << 4) / var13.mapPixelWidth
                  + (var5[var6] << 4) + var2.C25_f356;
            var12 = (var2.C25_f364[(var2.C25_f353 << 2) + 3] * var5[var6 + 6] << 3) / var13.mapPixelHeight
                  + (var5[var6 + 1] << 3) + var2.C25_f357;
            var3.setColor(16711680);
            var3.fillRect(var4, var12, 6, 6);
         }

         if (var2.C25_f354 != -1) {
            var4 = (var2.C25_f365[(var2.C25_f354 << 2) + 2] * var5[var6 + 5] << 4) / var13.mapPixelWidth
                  + (var5[var6] << 4) + var2.C25_f356;
            var12 = (var2.C25_f365[(var2.C25_f354 << 2) + 3] * var5[var6 + 6] << 3) / var13.mapPixelHeight
                  + (var5[var6 + 1] << 3) + var2.C25_f357;
         ...
         if (ScreenTransitionManager.a().C30_f523 != -1) {
            if (this.C25_f284.followTarget instanceof PlayerCharacter) {
               ScreenTransitionManager.a().b(this.C25_f284.worldX - TileMapRenderer.getInstance().cameraX,
                     this.C25_f284.worldY - TileMapRenderer.getInstance().cameraY
                           - this.C25_f328[this.C25_f286.currentVehicleType + 1]);
            } else {
               ScreenTransitionManager.a().b(this.C25_f284.worldX - TileMapRenderer.getInstance().cameraX,
                     this.C25_f284.worldY - TileMapRenderer.getInstance().cameraY - 20);
            }
         ...
         for (var4 = 0; var4 < var2.C25_f286.miscData.size(); ++var4) {
            var5 = (int[]) var2.C25_f286.miscData.elementAt(var4);
            GameUtils.a(var3, "+" + var5[0], 16704699, var5[1] + 12 - var2.C25_f283.cameraX,
                  var5[2] - var5[3] - var2.C25_f283.cameraY, 17, 17, var2.dialogManager.textRenderer, 2);
            var3.drawImage(C25_f299, var5[1] - var2.C25_f283.cameraX - 6, var5[2] - var5[3] - var2.C25_f283.cameraY,
                  20);
         }
         ...
         if (this.C25_f290 == 3 && this.C25_f291 == 7 && this.currentState == 0) {
            if (this.C25_f348.questEffectCounter > 0) {
               if (this.C25_f341 != null) {
                  var1.drawImage(this.C25_f341[this.C25_f348.questEffectCounter - 1], getScreenWidth() >> 1,
                        getScreenHeight() >> 1, 3);
                  return;
               }
   ...
   private void af() {
      ...
      if (!this.C25_f348.hasActiveEvent() && this.C25_f286.getFacingDirection() < 5 && !this.gameController.j()
            && this.gameController.J()) {
         if (this.isKeyHeld(4100)) {
            this.C25_f286.setFacingState((byte) 1, (byte) 2);
         } else if (this.isKeyHeld(8448)) {
            this.C25_f286.setFacingState((byte) 1, (byte) 0);
         } else if (this.isKeyHeld(16400)) {
            this.C25_f286.setFacingState((byte) 1, (byte) 3);
         } else if (this.isKeyHeld(32832)) {
            this.C25_f286.setFacingState((byte) 1, (byte) 1);
         }
         ...
         if (this.isKeyPressed(262144)) {
            ...
            if (var5) {
               ...
               for (var6 = 0; var6 < var1.C25_f367[var1.C25_f352].length / 7; ++var6) {
                  if (var1.C25_f367[var1.C25_f352][var6 * 7 + 2] == var1.C25_f290
                        && var1.C25_f367[var1.C25_f352][var6 * 7 + 3] == var1.C25_f291) {
                     var1.C25_f355 = var6;
                     break;
                  }
               }
               ...
               var1.C25_f359 = (getScreenHeight() >> 1) - (var1.C25_f367[var1.C25_f352][var1.C25_f355 * 7 + 1] << 3)
                     - 20;
               var1.C25_f360 = true;
               ...
               if (var1.C25_f362 == null) {
                  ...
                  for (var6 = 0; var6 < var1.C25_f362.length; ++var6) {
                     ...
                     if (var6 <= 1) {
                        var1.C25_f362[var6].setWorldPosition(getScreenWidth() >> 1,
                              20 + var6 * (getScreenHeight() - 20));
                     } else {
                        var1.C25_f362[var6].setWorldPosition(10 + var6 % 2 * (getScreenWidth() - 20),
                              getScreenHeight() >> 1);
                     }
               ...
               var1.C25_f286.setFacingState((byte) 0, (byte) var1.C25_f286.currentDirection);
            ...
            label235: {
               boolean var10;
               if (this.C25_f290 != 3 || this.C25_f291 != 7) {
                  if (this.C25_f286.currentVehicleType >= 0 && this.C25_f348.isEventVisible) {
                     if (this.C25_f286.canDismountVehicle()) {
                        this.C25_f286.resetToDefaultSprite();
                     }
      ...
      if (!this.C25_f348.hasActiveEvent() && !this.gameController.J() && !C25_f339 && C25_f340[0] != -1
      ...
      for (int var7 = 0; var7 < var1.C25_f286.miscData.size(); ++var7) {
         int[] var9;
         int[] var11 = var9 = (int[]) var1.C25_f286.miscData.elementAt(var7);
         var11[3] += 5;
         if (var9[3] > 30) {
            var1.C25_f286.miscData.removeElementAt(var7);
            --var7;
         }
      }
      ...
      if (this.gameController.d(C25_f317, C25_f316) && !this.gameController.j() && this.isKeyPressed(196640)) {
         if (GameUtils.pageCount < GameUtils.b()) {
            ...
            if (this.C25_f375) {
               ...
               if (this.C25_f373 < this.C25_f372.length - 1) {
                  this.C25_f286.addBadges(1);
                  this.gameController.b("Đạt được 1 huy hiệu");
               } else if (this.C25_f286.getBadgeState((byte) 7, (byte) 0) == 0) {
                  this.gameController.b("Đạt được hoàng kim huy hiệu");
                  this.C25_f286.setBadgeState((byte) 7, (byte) 0, (byte) 2);
   ...
   private boolean a(int[] var1) {
      ...
      if (!this.C()) {
         ...
         int var3 = GameUtils.getRandomInRange(C25_f306[C25_f297[this.C25_f290] + this.C25_f291][3],
               C25_f306[C25_f297[this.C25_f290] + this.C25_f291][4]);
         this.C25_f286.registerCreature((byte) ((byte) ResourceManager.gameDatabase[0][var1[0]][1]), var1[0], (byte) 1);
   ...
   public final void M() {
      if (this.C25_f286.shouldTriggerEncounter()) {
         boolean var10000;
         label47: {
         ...
         if (!var10000) {
            this.C25_f286.encounterStepsRemaining = this.C25_f286.getEncounterSteps();
            return;
         }
   ...
   public final boolean n(int var1) {
      for (int var2 = 0; var2 < this.C25_f329.length / 4; ++var2) {
         if (this.C25_f329[var2 << 2] == this.C25_f290 && this.C25_f329[(var2 << 2) + 1] == this.C25_f291
               && var1 == this.C25_f329[(var2 << 2) + 2]
               && this.C25_f286.badgeStates[this.C25_f329[(var2 << 2) + 3]][0] == 2) {
            return true;
         }
      }
   ...
   public final boolean O() {
      return this.C25_f286.pokedexCount == 0 && C25_f314 >= 10 || this.C25_f286.pokedexCount > 0 && C25_f314 >= 30;
   }
   ...
   private void ai() {
      ...
      for (int var2 = this.C25_f372.length - 1; var2 >= 0; --var2) {
         if (this.C25_f286.totalCreaturesSeen >= this.C25_f372[var2]) {
      ...
      switch (actionType) {
         case 1:
            ...
            if (currentAction == 3) {
               ...
               var2 = getLocalizedText(
                     ResourceManager.gameDatabase[0][this.C25_f286.partyPokemon[GameEngineBase.getActionData(1)].getSpeciesId()][0]);
               ++currentAction;
         ...
         case 4:
            if (currentAction == 0) {
               ...
               for (int var1 = 0; var1 < this.C25_f286.partySize; ++var1) {
                  if (this.C25_f286.partyPokemon[var1].getLevel() == C25_f340[0]
                        && this.C25_f286.partyPokemon[var1].getSpeciesId() == C25_f340[1]) {
               ...
               var2 = getLocalizedText(ResourceManager.getDatabaseValue((byte) 0,
                     (short) this.C25_f286.partyPokemon[GameEngineBase.getActionData(1)].getSpeciesId(), (byte) 0));
   ...
   public final void handleActionResponse() {
      ...
      switch (actionType) {
         ...
         case 6:
            if (currentAction == 3) {
               for (var1 = 0; var1 < this.C25_f286.equipmentInventory.size() + this.C25_f286.consumableInventory.size(); ++var1) {
                  if (var1 >= this.C25_f286.consumableInventory.size()) {
                     if (this.C25_f286.equipmentInventory.size() <= 0) {
                        break;
                     }

                     if (((int[]) this.C25_f286.equipmentInventory.elementAt(var1 - this.C25_f286.consumableInventory.size()))[0] == 14) {
                        setActionData(1, var1);
                        break;
                     }
                  }

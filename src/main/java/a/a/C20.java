...
public class C20 extends C60 {
   public SpriteManager C20_f261 = new SpriteManager();
   ...
   public final void a(byte var1, byte var2, byte var3) {
      this.C20_f261.setAnimationProperties(var1, (byte)-1);
      super.C60_f866 = var3;
   }

   public final boolean a() {
      return !this.C60_f858 ? false : this.C20_f261.updateAnimation();
   }
   ...
   public final void a(Graphics var1, int var2, int var3) {
      if (this.C60_f858) {
         if (this.C60_f866 == 3) {
            this.C20_f261.renderCurrentFrame(var1, this.C60_f861 - var2, this.C60_f862 - var3, (byte)1);
         } else {
            this.C20_f261.renderCurrentFrame(var1, this.C60_f861 - var2, this.C60_f862 - var3, (byte)0);
         }
      }
   }
   ...
   public final void b(Graphics var1, int var2, int var3) {
      if (this.C20_f263) {
         if (this.C60_f866 == 3) {
            this.C20_f261.renderCurrentFrame(var1, this.C60_f861 - var2, this.C60_f862 - var3, (byte)3);
         } else {
            this.C20_f261.renderCurrentFrame(var1, this.C60_f861 - var2, this.C60_f862 - var3, (byte)4);
         }
      }
   }
   ...
   public final void f() {
      if (this.C20_f261.isInvalid()) {
         this.d(true);
      } else if (GameUtils.checkCollisionWithShortArray(C25.B().C25_f283.C68_f943, C25.B().C25_f283.C68_f944, GameEngineBase.getScreenWidth(), GameEngineBase.getScreenHeight(), this.C60_f861, this.C60_f862, this.C20_f261.getCurrentFrameTriggers())) {
         this.d(true);
      } else {
         this.d(false);
      }
